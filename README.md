...
| [`03-模型家族`](03-模型家族) | GPT / Llama / Qwen / DeepSeek / Mistral / Gemma / Claude / Gemini / GLM 等（已开篇 00 八要素解构法 + 01 GPT系列 + 02 Llama系列 + 03 Qwen系列 + 04 DeepSeek系列 + 05 Mistral与Mixtral系列 + 06 Gemma系列 + 07 Claude系列·闭源API系第一家 + 08 Gemini系列·闭源API系第二家 + 09 GLM系列·填空续写一张脸 + 10 其他家族·五家五路的算力税） | §3 |
