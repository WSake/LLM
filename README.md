...
| [`06-应用开发`](06-应用开发) | API / Prompt / 工具调用 / Workflow（已开篇 01 Model API 与流式·接口基本功三件套） | §6 |
